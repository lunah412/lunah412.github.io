        ...
        success: function (data) {
            ...
            if(data){
                ...
                for (i = 0; i < data.events.length; i++) {
                    var j = i + 1;
                    if (data.events[i].dates.start.localTime){
                    ...
                    table += "<tr><td>" + j + "</td><td>" + date + "</td><td><a href = \"#detail\" onclick='detail(\""+data.events[i].id+"\")' >" + eventname +"</a></td><td>"+ cate +"</td><td>" + venues + "</td><td><button class=\"like\"></button></td></tr>";
...
async function detail(id) {
    ...
    $.ajax({
        ...
        success: function (eventdetail) {
            ...
            var table = "<table class=\"table table-striped win noshow\"  id = \"info\" style=\"margin-top: 10px;width:90%\">";
            ...
            if(eventdetail._embedded.attractions){
                ...
                table += "<tr><td><b>Artist/Team(s)</b></td><td>" +  artist  +"</td></tr>";
            }
